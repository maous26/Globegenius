...
router.get('/users', async (req, res) => {
    try {
        ...
        if (search) {
            filteredUsers = filteredUsers.filter(user => user.email.toLowerCase().includes(search.toString().toLowerCase()) ||
...
router.get('/routes', async (req, res) => {
    try {
        ...
        if (search) {
            filteredRoutes = filteredRoutes.filter(route => route.origin.toLowerCase().includes(search.toString().toLowerCase()) ||
