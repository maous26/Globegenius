          ...
          <div className="mb-8">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 bg-red-600/20 hover:bg-red-600/30 border border-red-500 rounded-xl transition text-red-300 hover:text-red-200"
              >
